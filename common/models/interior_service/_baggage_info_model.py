...
class BaggageInfoModel(CustomBaseModel):
    product_tag: Optional[str] = Field(None, description="品牌名", alias="productTag")
    ...
    code: Optional[str] = Field(None, description='行李代码', alias="code")
    sell_key: Optional[str] = Field(None, description='行李费用key', alias="sellKey")
    currency: Optional[str] = Field(None, description='币种', alias="currency")
